...
export default {
    ...
    mounted() {
        ...
        //创建一个立方体
        const boxGeometry = new THREE.PlaneGeometry(400, 400, 400)
        //创建材质
        this.materal = new THREE.MeshStandardMaterial({side: THREE.DoubleSide})
        ...
        //创建环境光
        const spotLight = new THREE.SpotLight(0x404040, 10)
        // 设置聚光光源位置
        ...
        spotLight.decay = 0.0;
        spotLight.add()
        this.scene.add(spotLight, new THREE.SpotLightHelper(spotLight))
        //创建渲染器
