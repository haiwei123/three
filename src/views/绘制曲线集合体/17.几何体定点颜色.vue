...
export default {
    ...
    methods: {
        ...
        createGeometry: function () {
            ...
            const colorVerties = new Float32Array([
                1, 0, 0,
                0, 1, 0,
                0, 0, 1,
                0.5, 0.5, 0
            ])
            const attributes = new THREE.BufferAttribute(verties, 3)
            const material = new THREE.PointsMaterial({ size: 10, vertexColors: true })
            const geometry = new THREE.BufferGeometry()
            geometry.attributes.position = attributes
            geometry.attributes.color = new THREE.BufferAttribute(colorVerties, 3)
        ...
        createGeometry1: function () {
            ...
            geometry.attributes.position = new THREE.BufferAttribute(verties, 3)
            geometry.attributes.color = new THREE.BufferAttribute(colorVerties, 3)
        ...
        createGeometry2: function () {
            ...
            const attributes = new THREE.BufferAttribute(verties, 3)
            const material = new THREE.LineBasicMaterial({ size: 10, vertexColors: true })
            const geometry = new THREE.BufferGeometry()
            geometry.attributes.position = attributes
            geometry.attributes.color = new THREE.BufferAttribute(colorVerties, 3)
            const pointMesh = new THREE.Line(geometry, material)
            this.scene.add(pointMesh)
        }
    },
    mounted() {
