...
export default {
    ...
    methods: {
        ...
        createGeometry: function () {
            ...
            const ellipseCurve = new THREE.EllipseCurve(150, 0, 100, 50)
            ...
            //创建圆弧线(x原点，y原点，半径, 开始角度，结束角度, 是否顺时针绘制)
            const arcCurye = new THREE.ArcCurve(-150, 0, 100, 0, Math.PI * 2, false);
            const pointsArcle = arcCurye.getPoints(50)
            const bufferGeometry1 = new THREE.BufferGeometry().setFromPoints(pointsArcle)
            const line1 = new THREE.Points(bufferGeometry1, material)
