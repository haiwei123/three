...
import bufferGeometryVue from '@/components/bufferGeometry.vue';
...
export default {
    ...
    methods: {
        ...
        createGeometry: function () {
            //创建椭圆曲线（x原点，y原点，x半径, Y半径，开始角度，结束角度, 是否顺时针绘制）
            ...
            const line = new THREE.Points(bufferGeometry, material)
            this.scene.add(line)
        }
    },
    mounted() {
